...
import Footer from './Footer/Footer';
    ...
    return (
        <>
        <NavBar/>
        <div className='border' style={{color: "#000"}}>
                                ...
                                <div className="ordersummary flexcol">
                                    <div className="summarybanner ">
                                        <div className="flex">
                                            ...
                                            <h6 style={{ color: '#FFFFFF', marginTop:15 , marginLeft: 10 }}>Minimum Order Surcharge</h6>
                                            <AiFillInfoCircle color='#FFFFFF' style={{ marginTop: 13, marginLeft: 10 }} />
                                        </div>
                                    ...
                                    <div className="summarybanner1 ">
                                        ...
                                        <Link to='/checkout'><button className='btn' style={{color: '#fff' , border: '2px solid #fff'}}>PROCEED TO CHECKOUT</button></Link>
